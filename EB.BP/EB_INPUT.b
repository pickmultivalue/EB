...
* Changed by PORTBAS ->     SUBROUTINE EB.INPUT(INP.STRING,INP.FLD,LENTH,UNDERLINE.FLAG,MAT EB$CHARS,MAT OTHER.PARAMS,FG$EB.PARAMS,UMODE,CURS.ON,CURS.OFF,CURS.BLOCK,CURS.LINE,INIT.FLAG,ROW,HELP.ID,EB.CMD)
* @(#) EB_INPUT.b Ported to jBASE 07:23:52  18 FEB 2010
* @(#) EB.INPUT Ported to jBASE 16:15:15  27 JUL 2001
!INCLUDE jutil.h
