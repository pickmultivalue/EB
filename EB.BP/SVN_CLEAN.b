    FUNCTION SVN_CLEAN(HomeDir, F.Source, ItemName)
!
! Program designed to clean up a user's home/dir
! directory after committing or removing
! item from a previous svn check out
! F.Source is assumed to be opened to the /home/<user>/dir
!
! Note: due to subversion peculiarities items are not
! removed from the home check out area individually.
! Once all items are either checked in or reverted
! the whole directory involved is then removed.
!
