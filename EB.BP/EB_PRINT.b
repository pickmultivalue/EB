...
!
    ...
    IF IDATA EQ ESC OR FG_ACT.CODE EQ FG_ABT.CODE THEN RETURN
...
5040 CRT MSG.CLR:"From line or (S)creen or (W)hole? ":
    ...
    CRT MSG.AKN:
    IF FRLN EQ ESC OR FG_ACT.CODE EQ FG_ABT.CODE THEN RETURN
...
5060 !
    ...
    CRT MSG.AKN:
    IF TOLN EQ ESC OR FG_ACT.CODE EQ FG_ABT.CODE THEN RETURN
