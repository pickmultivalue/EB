...
STERM.RESUME:       !
        ...
        LOOP
            ...
            IF VALIDATE ELSE
                IF FG_STERM THEN
                    R.TABLE<6>=0
                    IF DISP.VALUES<1,NBR.VALS> EQ FG_ERROR.MSGS<105> THEN DEL DISP.VALUES<1,NBR.VALS>; R.TABLE<6>=1
                    IF DISP.VALUES<1,NBR.VALS> EQ FG_ERROR.MSGS<51> THEN DEL DISP.VALUES<1,NBR.VALS>; R.TABLE<6>=1
                END
            END
