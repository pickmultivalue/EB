    SUBROUTINE EB_MERGE(FIL,REC,CHANGED,MREC,POS,READ.AGAIN,LCOL,LROW,ROW,INDROW,PR,MSG.CLR,MSG.AKN,FLNM,MFLNM,ITNM,MITNM,DCT,MDCT)
...
!
    ...
    CRT MSG.AKN:
    IF AFTL EQ ESC OR FG_ACT.CODE EQ FG_ABT.CODE THEN GO 5090
...
5010 CRT MSG.CLR:"Merge from file ":
    ...
    MFLNM=IDATA
    CRT MSG.AKN:
    IF FG_ACT.CODE EQ FG_ABT.CODE THEN GO 5090
