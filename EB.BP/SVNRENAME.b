! PROGRAM SVNRENAME
!
! Subversion wrapper to rename a program
!
...
!
IO = SVN_SRC_STATUS(FullPath, ITEMNAME)
...
CRT SVN_EXEC('revert ':FilePath, 1)
CRT SVN_EXEC('add ':NewPath, 1)
DELETE F.Source, ITEMNAME
END ELSE
SVN_EXEC('rename ':FilePath:' ':NewPath, 0)
END
