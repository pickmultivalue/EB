    ...
    path = EBGETHOME()
    OPEN path:'EB.PARAMS' TO FG$EB.PARAMS ELSE STOP OPER,'EB.PARAMS'
    OPEN path:'EB.SECURITY' TO FG$SECURITY ELSE STOP OPER,'EB.SECURITY'
    OPEN path:'EB.TERM-TYPES' TO TERM.FILE ELSE STOP OPER,'EB.TERM-TYPES'
    OPEN path:'EB.CONTROL' TO FG$EB.CONTROL ELSE FG$EB.CONTROL=FG$EB.PARAMS
!
