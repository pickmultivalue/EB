    ...
    MAT OTHER.PARAMS = ''
    FOR i = 1 TO 100
        IF UNASSIGNED(OTHER.PARAMS(i)) THEN OTHER.PARAMS(i) = ''
    NEXT i
    DEFFUN EBGETHOME()
...
!
    ...
    READ HEXFILE FROM FG_EB.PARAMS,'CRT@':TERM.TYPE ELSE
        CRT 'Unknown EB term type: ':TERM.TYPE
        STOP
    END
...
!        FG=''
!    END
    READ HEXFILE FROM FG_EB.PARAMS,'EB.CHARS@':KEYBOARD.TYPE ELSE
